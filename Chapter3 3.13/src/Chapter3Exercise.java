...
public class Chapter3Exercise {
	...
	public static void main(String[] args) {
		// Financial application; Computation of taxes
		
		// Create a Scanner to the system
		  ...
		  if (status == 0) { // Compute the  taxes for single filers
		   if (income <= 8350)
		    tax = income * 0.10;
		  ...
		  } else if (status == 1) { // Compute the taxes for married and file jointly
		   if (income <= 16700)
		    tax = income * 0.10;
		  ...
		  } else if (status == 2) { // Compute taxes for married and file separately
		   if (income <= 8350)
		    tax = income * 0.10;
		   else if (income <= 33950)
		    tax = 8350 * 0.10 + (income - 8350) * 0.15;
		  ...
		  } else if (status == 3) { // Compute the taxes for head of household
		   if (income <= 11950)
		    tax = income * 0.10;
